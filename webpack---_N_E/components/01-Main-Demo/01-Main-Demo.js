...
const MainDemo = () => {
    ...
    return ( <
        ...
        <
        Card col = "col-lg-4 col-md-6 col-sm-6 col-12"
        mt = "mt--30"
        start = {
            0
        }
        ...
        <
        Link className = "rbt-btn btn-gradient btn-lg hover-icon-reverse"
        href = "#" >
        <
        ...
        <
        Link className = "rbt-btn btn-gradient hover-icon-reverse"
        href = "/blog" >
        <
