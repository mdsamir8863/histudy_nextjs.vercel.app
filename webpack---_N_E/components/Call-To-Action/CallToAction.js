            ...
            CallToActionData.collectionOne.map((data, index) => ( <
                ...
                key = {
                    ...
                    data.left.map((item, innerIndex) => ( <
                        ...
                        <
                        Image className = "w-100 rbt-radius"
                        src = {
                            item.img
                        }
                        width = {
                        ...
                        >
                        <
                        Link className = "rbt-btn rounded-player-2 sm-size popup-video position-to-top with-animation"
                        data - vbtype = "video"
                    ...
                    data.right.map((item, innerIndex) => ( <
                        ...
                        <
                        Link className = "rbt-btn rbt-switch-btn btn-gradient btn-sm"
                        href = "#" >
                        <
