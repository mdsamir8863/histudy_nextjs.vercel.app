...
const Category = () => {
    return ( <
        ...
        /span> <
        i title = "Category"
        className = "feather-grid d-block d-xl-none" > < /i> <
        /div> <
        ...
        <
        SingleCategory title = "Course School"
        isActive = {
            false
        }
        CategoryData = {
        ...
        CategoryNum = {
            CategoryData.categoryItemOne
        }
        /> <
        SingleCategory title = "Online School"
        isActive = {
            false
        }
        CategoryData = {
        ...
        /> <
        SingleCategory title = "kindergarten"
        isActive = {
            false
        }
        CategoryData = {
        ...
        CategoryNum = {
            CategoryData.categoryItemThree
        }
        /> <
