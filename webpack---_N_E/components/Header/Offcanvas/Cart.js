...
const Cart = () => {
    ...
    return ( <
        ...
        <
        div className = {
            `${!cartToggle ? "cart-sidenav-menu-active" : ""}`
        } >
        <
        div className = {
            `rbt-cart-side-menu ${
        ...
        <
        Link className = "rbt-btn btn-border icon-hover w-100 text-center"
        href = "/cart" >
        <
        ...
        <
        Link className = "rbt-btn btn-gradient icon-hover w-100 text-center"
        href = "/checkout" >
        <
        ...
        /div> <
        /div> <
        Link className = "close_side_menu"
        href = "#"
        onClick = {
            () => setCart(!cartToggle)
        } >
