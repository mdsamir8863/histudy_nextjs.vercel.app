...
const HeaderTopBar = () => {
    ...
    return ( <
        ...
        <
        div className = {
            `rbt-header-campaign rbt-header-campaign-1 rbt-header-top-news bg-image1 ${
          !toggle ? "deactive" : ""
        }`
        } >
        <
        ...
        alt = "Hand Emojji Images" / > Intro price.Get Histudy
        for Big Sale - 95 % off. <
        /span> <
        /div> <
        div className = "right-button" >
        <
        Link className = "rbt-btn-link color-white"
