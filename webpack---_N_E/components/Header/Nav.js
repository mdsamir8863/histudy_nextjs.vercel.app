...
const Nav = () => {
    ...
    return ( <
        ...
        <
        CourseLayout courseTitle = "Course Layout"
        MenuData = {
            MenuData
        }
        type = "grid-item-2"
        ...
        <
        Link className = "rbt-btn btn-gradient hover-icon-reverse square btn-xl w-100 text-center mt--30 hover-transform-none"
        href = "#" >
        <
