    ...
    [2141], {
        73431: function(t) {
            ...
            t.exports = function(t, r, a, l) {
                if (!(0 <= t && t <= 1 && 0 <= a && a <= 1)) throw Error("bezier x values must be in [0, 1] range");
                if (t === r && a === l) return n;
                for (var o = e ? new Float32Array(11) : Array(11), h = 0; h < 11; ++h) o[h] = i(.1 * h, t, a);
                return function(e) {
                    return 0 === e ? 0 : 1 === e ? 1 : i(function(e) {
                        for (var n = 0, r = 1; 10 !== r && o[r] <= e; ++r) n += .1;
                        var l = n + (e - o[--r]) / (o[r + 1] - o[r]) * .1,
                            h = s(l, t, a);
                        return h >= .001 ? function(t, e, n, r) {
                            ...
                            return e
                        }(e, l, t, a) : 0 === h ? l : function(t, e, s, n, r) {
                            var a, l, o = 0;
                            do(a = i(l = e + (s - e) / 2, n, r) - t) > 0 ? s = l : e = l; while (Math.abs(a) > 1e-7 && ++o < 10);
                            return l
                        }(e, n, n + .1, t, a)
                    }(e), r, l)
                }
        ...
        72141: function(t, e, i) {
            ...
            var s, n, r, a, l, o, h, u, c, d, p, f = i(73431),
                v = i.n(f),
                g = function(t) {
                ...
                E = function() {
                    ...
                    return t.prototype._setRectWithRootMargin = function(t) {
                        var e = t.top + t.bottom,
                            i = t.left + t.right;
                        this.top -= t.top, this.right += t.right, this.bottom += t.bottom, this.left -= t.left, this.height += e, this.width += i
                    }, t
                }(),
                C = [c[""], h.px, h["%"], h.vh, h.vw, u.deg, u.turn, u.rad];
            ...
            function b(t, e) {
                ...
                if (!("number" == typeof t || "string" == typeof t)) throw Error("Invalid value provided. Must provide a value as a string or number");
                if (t = String(t), i.value = parseFloat(t), i.unit = t.match(/[\d.\-+]*\s*(.*)/)[1] || e, !C.includes(i.unit)) throw Error("Invalid unit provided.");
                return i
            }
            var _ = {
                ease: [.25, .1, .25, 1],
            ...
            function I(t, e) {
                ...
                return x.forEach(function(s) {
                    ...
                    if ("number" == typeof(null == t ? void 0 : t[s])) {
                        ...
                        e === d.vertical && (i.translateY = o), e === d.horizontal && (i.translateX = o)
                    }
                    if (Array.isArray(null == t ? void 0 : t[s])) {
                        var h = null == t ? void 0 : t[s];
                        if (void 0 !== h[0] && void 0 !== h[1]) {
                            var u = b(null == h ? void 0 : h[0], n),
                                c = b(null == h ? void 0 : h[1], n),
                            ...
                            if (i[s] = {
                                    ...
                                    unit: u.unit,
                                    easing: p
                                }, u.unit !== c.unit) throw Error("Must provide matching units for the min and max offset values of each axis.")
                        }
                    }
                }), i
            }
            ...
            function P(t, e) {
                var i, s;
                return {
                    value: (i = "function" == typeof t.easing ? t.easing(e) : e, s = (null == t ? void 0 : t.start) || 0, (((null == t ? void 0 : t.end) || 0) - s) * (i - 0) / 1 + s),
            ...
            function A(t, e, i) {
                return Math.max(i / (i + (Math.abs(t) + Math.abs(e)) * (e > t ? -1 : 1)), 1)
            }
            ...
            var H = {
                ...
                z = function() {
                    function t(t) {
                        var e, i;
                        this.el = t.el, this.props = t.props, this.scrollAxis = t.scrollAxis, this.disabledParallaxController = t.disabledParallaxController || !1, this.id = ++w, this.effects = I(this.props, this.scrollAxis), this.isInView = null, this.progress = 0, this._setElementEasing(t.props.easing), e = t.el, i = Object.keys(this.effects).includes("opacity"), e.style.willChange = "transform" + (i ? ",opacity" : "")
                    }
                    var e = t.prototype;
                    return e.updateProps = function(t) {
                        return this.props = m({}, this.props, t), this.effects = I(t, this.scrollAxis), this._setElementEasing(t.easing), this
                    }, e.setCachedAttributes = function(t, e) {
                        X(this), this.rect = new E({
                            el: this.props.targetElement || this.el,
                            rootMargin: this.props.rootMargin,
                            view: t
                        });
                        var i, s, n, r, a, l, o, h, u, c, p, f, v = (i = this.props, s = this.effects, n = this.scrollAxis, !i.rootMargin && !i.targetElement && !i.shouldDisableScalingTranslations && (!!s.translateX && n === d.horizontal || !!s.translateY && n === d.vertical));
                        return "number" == typeof this.props.startScroll && "number" == typeof this.props.endScroll ? this.limits = new g({
                            startX: this.props.startScroll,
                            startY: this.props.startScroll,
                            endX: this.props.endScroll,
                            endY: this.props.endScroll
                        }) : v ? (this.limits = function(t, e, i, s, n, r) {
                            var a = i.translateX || H,
                                ...
                                C = 1,
                                b = 1;
                            n === d.vertical && (b = C = A(p, f, e.height + t.height));
                            var _ = 1,
                                y = 1;
                            if (n === d.horizontal && (y = _ = A(h, u, e.width + t.width)), p < 0 && (v += p * C), f > 0 && (w += f * b), h < 0 && (m += h * _), u > 0 && (E += u * y), m += s.x, E += s.x, v += s.y, w += s.y, r) {
                                var x = s.y + t.top < e.height,
                                    O = s.x + t.left < e.width,
                                    I = s.y + t.bottom > e.scrollHeight - e.height,
                                    S = s.x + t.right > e.scrollWidth - e.height;
                                x && I && (C = 1, b = 1, v = 0, w = e.scrollHeight - e.height), O && S && (_ = 1, y = 1, m = 0, E = e.scrollWidth - e.width), !x && I && (v = t.top - e.height + s.y, C = A(p, f, (w = e.scrollHeight - e.height) - v), b = 1, p < 0 && (v += p * C)), !O && S && (m = t.left - e.width + s.x, _ = A(h, u, (E = e.scrollWidth - e.width) - m), y = 1, h < 0 && (m += h * _)), x && !I && (v = 0, C = 1, b = A(p, f, (w = t.bottom + s.y) - v), f > 0 && (w += f * b)), O && !S && (m = 0, _ = 1, y = A(h, u, (E = t.right + s.x) - m), u > 0 && (E += u * y))
                            }
                            return new g({
                                startX: m,
                                startY: v,
                        ...
                        }(this.rect, t, this.effects, e, this.scrollAxis, this.props.shouldAlwaysCompleteAnimation), this.scaledEffects = (r = this.effects, a = this.limits, (l = m({}, r)).translateX && (l.translateX = m({}, r.translateX, {
                            start: l.translateX.start * a.startMultiplierX,
                            end: l.translateX.end * a.endMultiplierX
                        })), l.translateY && (l.translateY = m({}, r.translateY, {
                            start: l.translateY.start * a.startMultiplierY,
                            end: l.translateY.end * a.endMultiplierY
                        })), l)) : this.limits = (o = this.rect, h = this.props.shouldAlwaysCompleteAnimation, u = o.top - t.height, c = o.left - t.width, p = o.bottom, f = o.right, c += e.x, f += e.x, u += e.y, p += e.y, h && (e.y + o.top < t.height && (u = 0), e.x + o.left < t.width && (c = 0), p > t.scrollHeight - t.height && (p = t.scrollHeight - t.height), f > t.scrollWidth - t.width && (f = t.scrollWidth - t.width)), new g({
                            startX: c,
                            startY: u,
                            endX: f,
                            endY: p
                        })), this._setElementStyles(), this
                        ...
                        this.props.disabled || this.disabledParallaxController || function(t, e, i) {
                            if (i) {
                                var s, n = Y.reduce(function(i, s) {
                                        var n = t[s] && P(t[s], e);
                                        return void 0 === n || void 0 === n.value || void 0 === n.unit ? i : i + (s + "(" + n.value) + n.unit + ")"
                                    }, ""),
                                    r = void 0 === (s = t.opacity && P(t.opacity, e)) || void 0 === s.value || void 0 === s.unit ? "" : "" + s.value;
                        ...
                        this.scrollAxis = t.scrollAxis, this.disabledParallaxController = t.disabledParallaxController || !1
                        ...
                        } else i && (this.progress = k(Math.round(S(s, r, a, this.easing)), 0, 1), this._setElementStyles());
                        return this
                    }, t
                }(),
                Q = function() {
                ...
                W = function() {
                    function t(t) {
                        var e = t.scrollAxis,
                            ...
                            s = t.scrollContainer,
                            n = t.disabled;
                        this.disabled = void 0 !== n && n, this.scrollAxis = i, this.elements = [], this._hasScrollContainer = !!s, this.viewEl = null != s ? s : window;
                        var r = this._getScrollPosition(),
                            a = r[0],
                            l = r[1];
                        this.scroll = new L(a, l), this.view = new Q({
                            width: 0,
                            height: 0,
                            scrollWidth: 0,
                            scrollHeight: 0,
                            ...
                            return t
                        }(), this._bindAllMethods(), this.disabled || (this._addListeners(this.viewEl), this._addResizeObserver(), this._setViewSize())
                    }
                    t.init = function(e) {
                        if (!("undefined" != typeof window)) throw Error("Looks like ParallaxController.init() was called on the server. This method must be called on the client.");
                        return new t(e)
                    };
                    var e = t.prototype;
                    return e._bindAllMethods = function() {
                        ...
                        var t, e = this._getScrollPosition(),
                            i = e[0],
                            s = e[1];
                        this.scroll.setScroll(i, s), !this._ticking && (null == (t = this.elements) ? void 0 : t.length) > 0 && (this._ticking = !0, window.requestAnimationFrame(this._updateAllElements))
                        ...
                        this.elements && this.elements.forEach(function(t) {
                            i && t.setCachedAttributes(e.view, e.scroll), e._updateElementPosition(t)
                        }), this._ticking = !1
                    }, e._updateElementPosition = function(t) {
                        t.props.disabled || this.disabled || t.updatePosition(this.scroll)
                        ...
                        this.elements && (this.elements = this.elements.map(function(i) {
                        ...
                        var t = this._getScrollPosition(),
                            e = t[0],
                            i = t[1];
                        this.scroll.setScroll(e, i), this._setViewSize(), this._updateAllElements({
                            updateCache: !0
                        })
                    }, e.updateScrollContainer = function(t) {
                        this._removeListeners(this.viewEl), this.viewEl = t, this._hasScrollContainer = !!t, this.view = new Q({
                            width: 0,
                            height: 0,
                            scrollWidth: 0,
                            scrollHeight: 0,
                        ...
                        this.disabled = !0, this._removeListeners(this.viewEl), this.elements && this.elements.forEach(function(t) {
                            return X(t)
                        })
                    }, e.enableParallaxController = function() {
                        var t = this;
                        this.disabled = !1, this.elements && this.elements.forEach(function(e) {
                        ...
                        console.warn("deprecated: use disableParallaxController() instead"), this.elements && (this.elements = this.elements.map(function(t) {
                            return t.updateProps({
                                disabled: !0
                            })
                        })), this.update()
                    }, e.enableAllElements = function() {
                        console.warn("deprecated: use enableParallaxController() instead"), this.elements && (this.elements = this.elements.map(function(t) {
                            return t.updateProps({
                                disabled: !1
                            })
                        })), this.update()
                ...
                V = i(67294),
                B = ["disabled", "easing", "endScroll", "onChange", "onEnter", "onExit", "onProgressChange", "opacity", "rootMargin", "rotate", "rotateX", "rotateY", "rotateZ", "scale", "scaleX", "scaleY", "scaleZ", "shouldAlwaysCompleteAnimation", "shouldDisableScalingTranslations", "speed", "startScroll", "targetElement", "translateX", "translateY"],
                Z = V.createContext(null);

            function R(t) {
                var e, i, s, n, r, a, l, o, h, u, c, d, p, f, v, g, m, w, E, C, b, _, y, x, O, I, S = function() {
                        var t = (0, V.useContext)(Z);
                        if ("undefined" == typeof window) return null;
                        if (!t) throw Error("Could not find `react-scroll-parallax` context value. Please ensure the component is wrapped in a <ParallaxProvider>");
                        return t
                    }(),
                    P = (0, V.useRef)(null),
                    Y = (e = t.disabled, i = t.easing, s = t.endScroll, n = t.onChange, r = t.onEnter, a = t.onExit, l = t.onProgressChange, o = t.opacity, h = t.rootMargin, u = t.rotate, c = t.rotateX, d = t.rotateY, p = t.rotateZ, f = t.scale, v = t.scaleX, g = t.scaleY, m = t.scaleZ, w = t.shouldAlwaysCompleteAnimation, E = t.shouldDisableScalingTranslations, C = t.speed, b = t.startScroll, _ = t.targetElement, y = t.translateX, x = t.translateY, O = function(t, e) {
                        if (null == t) return {};
                        var i, s, n = {},
                            r = Object.keys(t);
                ...
                (0, V.useEffect)(function() {
                    var t = "undefined" == typeof window,
                        e = S instanceof W;
                    if (!t && !S && !e) throw Error("Must wrap your application's <Parallax /> components in a <ParallaxProvider />.")
                }, [S]);
                var X = (0, V.useState)(),
                    A = X[0],
                    M = X[1];
                return (0, V.useEffect)(function() {
                    ...
                    A && (t.disabled && (null == S || S.resetElementStyles(A)), null == S || S.updateElementPropsById(A.id, Y))
            ...
            function T(t) {
                var e, i = (0, V.useRef)(null);
                return i.current || (i.current = (e = {
                    scrollAxis: t.scrollAxis || d.vertical,
                    scrollContainer: t.scrollContainer,
                    disabled: t.isDisabled
                }, "undefined" != typeof window ? W.init(e) : null)), (0, V.useEffect)(function() {
                    t.scrollContainer && i.current && i.current.updateScrollContainer(t.scrollContainer)
                }, [t.scrollContainer, i.current]), (0, V.useEffect)(function() {
                    t.isDisabled && i.current && i.current.disableParallaxController(), !t.isDisabled && i.current && i.current.enableParallaxController()
                }, [t.isDisabled, i.current]), (0, V.useEffect)(function() {
                    return function() {
                        (null == i ? void 0 : i.current) && (null == i || i.current.destroy())
                    }
                }, []), V.createElement(Z.Provider, {
                    value: i.current
                }, t.children)
            }
        }
...
//# sourceMappingURL=2141-44d9b2cb02a96f30.js.map