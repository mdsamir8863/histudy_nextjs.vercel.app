    ...
    [3424], {
        ...
        81032: function(e, t, n) {
            ...
            let _ = r.default.forwardRef(function(e, t) {
                ...
                n = O, A && ("string" == typeof n || "number" == typeof n) && (n = r.default.createElement("a", null, n));
                let I = r.default.useContext(c.RouterContext),
                    L = r.default.useContext(i.AppRouterContext),
                    S = null != I ? I : L,
                    x = !I,
                    N = !1 !== g,
                    U = null === g ? y.PrefetchKind.AUTO : y.PrefetchKind.FULL,
                    {
                        href: w,
                        as: K
                    } = r.default.useMemo(() => {
                        ...
                        let [e, t] = (0, o.resolveHref)(I, b, !0);
                        return {
                            href: e,
                            as: _ ? (0, o.resolveHref)(I, _) : t || e
                        }
                    }, [I, b, _]),
                    F = r.default.useRef(w),
                    H = r.default.useRef(K);
                A && (l = r.default.Children.only(n));
                let D = A ? l && "object" == typeof l && l.ref : t,
                    [V, q, z] = (0, s.useIntersection)({
                        rootMargin: "200px"
                    }),
                    B = r.default.useCallback(e => {
                        (H.current !== K || F.current !== w) && (z(), H.current = K, F.current = w), V(e), D && ("function" == typeof D ? D(e) : "object" == typeof D && (D.current = e))
                    }, [K, D, w, z, V]);
                r.default.useEffect(() => {
                    S && q && N && h(S, w, K, {
                        locale: j
                ...
                }, [K, w, q, j, N, null == I ? void 0 : I.locale, S, x, U]);
                let G = {
                    ref: B,
                    onClick(e) {
                        A || "function" != typeof m || m(e), A && l.props && "function" == typeof l.props.onClick && l.props.onClick(e), S && !e.defaultPrevented && function(e, t, n, o, l, f, a, c, i) {
                            let {
                                nodeName: s
                            } = e.currentTarget;
                            if ("A" === s.toUpperCase() && (function(e) {
                                ...
                                }(e) || !i && !(0, u.isLocalURL)(n))) return;
                            e.preventDefault();
                            let d = () => {
                                let e = null == a || a;
                                "beforePopState" in t ? t[l ? "replace" : "push"](n, o, {
                                    shallow: f,
                                    locale: c,
                                    scroll: e
                            ...
                            i ? r.default.startTransition(d) : d()
                        }(e, S, w, K, E, P, T, j, x)
                    },
                    onMouseEnter(e) {
                        A || "function" != typeof M || M(e), A && l.props && "function" == typeof l.props.onMouseEnter && l.props.onMouseEnter(e), S && (N || !x) && h(S, w, K, {
                            locale: j,
                            priority: !0,
                    ...
                    onTouchStart(e) {
                        A || "function" != typeof R || R(e), A && l.props && "function" == typeof l.props.onTouchStart && l.props.onTouchStart(e), S && (N || !x) && h(S, w, K, {
                            locale: j,
                            priority: !0,
                            bypassPrefetchedCheck: !0
                        }, {
                ...
                else if (!A || C || "a" === l.type && !("href" in l.props)) {
                    let e = void 0 !== j ? j : null == I ? void 0 : I.locale,
                        t = (null == I ? void 0 : I.isLocaleDomain) && (0, d.getDomainLocale)(K, e, null == I ? void 0 : I.locales, null == I ? void 0 : I.domainLocales);
                    G.href = t || (0, p.addBasePath)((0, a.addLocale)(K, e, null == I ? void 0 : I.defaultLocale))
                }
                return A ? r.default.cloneElement(l, G) : r.default.createElement("a", { ...k,
                    ...G
                }, n)
            });
...
//# sourceMappingURL=3424-d7401195fc6e0ccb.js.map